...
export const functionContext = createContext<Dispatch<action>>(() => { });
            ...
            <Modal open={open} onClose={() => setOpen(false)}>
                <Box sx={style}>
                    <form onSubmit={async (e) => {
                        ...
                        console.log("fistnameref-before try " + firstNameRef.current?.value);
                        ...
                        try {
                            ...
                            console.log("emailref after tery " + firstNameRef.current?.value);
                            ...
                            console.log("firstname ref finally: " + firstNameRef.current?.value);
